...
$_SESSION["title_update"]="";
$var1 = $_POST['t27'];
$_SESSION["title_update"]=$_SESSION["title_update"]."$var1";
?>
...
$_SESSION["e_title"] = $_SESSION["e_title"]."$z1";
$_SESSION["e_date"] = $_SESSION["e_date"]."$z2";
$_SESSION["e_category"] = $_SESSION["e_category"]."$z3";
...
?>
	...
	<form action="article.php" method="post" enctype="multipart/form-data">
		<div class="Title">
			...
			<textarea name="title" rows="2" cols="100" placeholder="Enter Title ... " style="font-size: 15px;"  required><?php
			 echo $_POST['t27'];
			 ?></textarea>
		</div>
		<div class="category">
		...
		<div class="description">
			<div>
				...
				<textarea name="description" rows="6" cols="100" placeholder="Enter Your Article ...." style="font-size: 15px;"><?php
					  ...
					  $numrows=mysqli_num_rows($results);
					   ...
					   for($j=0;$j<$numrows;++$j){
					       ...
					       if ($_SESSION["categ_update"]==$rows[5] && $_SESSION["date_update"]==$rows[8] && $_SESSION["title_update"]==$rows[4]) {
					       		echo $rows[6];
					        } 
					   } 
					?></textarea>
		...
		<div class="sideImg">
			<b>Upload Image</b>
			<input type="file" name="sideImg">
		</div>

		<div>
			<input type="Submit" name="submitForm" value="Submit Edit Article" class="submitArtBtn">
		</div>
	</form>
	<p id="demo"></p>
	<footer>
