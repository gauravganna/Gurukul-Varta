...
$query = "SELECT * FROM articles WHERE category='Miscellaneous' ORDER BY id DESC";
...
<body>	
	...
	<section class="mainBody">
		...
		<div class="belowMainArticle">
			<div class="leftSide">
				<h2 class="page-title">Miscellaneous</h2>
				...
				<?php 
					while($row = mysqli_fetch_assoc($result)) {
						echo '<div>';
							echo '<a href="article.php?type=miscellaneous&id=' . $row['id'] . '"><div class="other-image" style="background-image: url(Images/' . $row['article_image'] . ');"></div></a>';
							echo '<div class="other-description">';
								echo '<a href="article.php?type=miscellaneous&id=' . $row['id'] . '"><div class="other-title">';
									echo $row['title'];
								echo '</div></a>';
